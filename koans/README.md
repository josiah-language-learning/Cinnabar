...
| `mode-system/` | 01-inst, 02-inference, 03-higher-order-inst, 04-uniqueness-violation, 05-mode-errors (set), 06-negation-bindings, 07-function-semidet |
| `determinism/` | 01-det-mismatch, 02-nondet-in-det, 03-committed-choice, 04-determinism-errors (set), 05-promise-equivalent-solutions, 06-cc-nondet-solutions, 07-nondet-condition-multi |
